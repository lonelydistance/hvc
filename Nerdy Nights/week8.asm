; NintendoAge Nerdy Nights Week 8 - Background part 3
...
;;;;;;;;;;;;;;;
       ...
       ; put pointers in zero page
pointerLo  equ $0000  ; pointer variables are declared in RAM
pointerHi  equ $0001   ; low byte first, high byte immediately after
...
LoadBackground:
  ...
  lda #<background      ; load the source address into a pointer in zero page
  sta pointerLo
  lda #>background
  sta pointerLo+1
